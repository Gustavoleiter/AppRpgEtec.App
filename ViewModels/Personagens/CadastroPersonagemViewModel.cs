...
namespace AppRpgEtec.ViewModels.Personagens
{
    ...
    public class CadastroPersonagemViewModel : BaseViewModel
    {
        ...
        private TipoClasse tipoClasseSelecioado;

        public TipoClasse TipoClasseSelecionado
        {
            get { return tipoClasseSelecioado; }
            set
            {
                if (value != null)
                {
                    tipoClasseSelecioado = value;
                    OnPropertyChanged();
                }
            }
        }
        ...
        public async Task ObterClasses()
        {
            try
            {
                ...
                ListaTiposClasse.Add(new TipoClasse() { Id = 1, Descricao = "Mago" });
        ...
        public string PersonagemSelecionado { get => personagemSelecionadoId; set => personagemSelecionadoId = value; }
        ...
        public async Task SalvarPersonagem()
        {
            try
            {
                Personagem model = new Personagem()
                {
                    ...
                    Id = this.id,
                    Classe = (ClasseEnum)tipoClasseSelecioado.Id
                };
                if (model.Id == 0)
